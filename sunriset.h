...
/* Sunrise/set is considered to occur when the Sun's upper limb (upper edge) is
/ * 50 arc minutes below the horizon */
/* (this accounts for the refraction of the Earth's atmosphere). */
/* Civil twilight starts/ends when the Sun's center is 6 degrees below the
/ * horizon. */
/* Nautical twilight starts/ends when the Sun's center is 12 degrees below the
/ * horizon. */
/* Astronomical twilight starts/ends when the Sun's center is 18 degrees below
/ * the horizon. */
